...
const MagicButton = ({
  ...
  return (
    <button 
      onClick={handleClick}
      className="relative inline-flex h-12 w-full overflow-hidden rounded-lg p-[1px] focus:outline-none md:w-60 my-4 hover:scale-[1.03] transition-all duration-300"
    >
