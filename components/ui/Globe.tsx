...
// Extend ThreeJS elements with ThreeGlobe
extend({ ThreeGlobe });

// Proper type declaration for ThreeGlobe
declare global {
  namespace JSX {
...
// Proper module augmentation for react-three-fiber
...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  useEffect(() => {
    if (globeRef.current && globeData) {
      globeRef.current
        ...
        .atmosphereAltitude(defaultProps.atmosphereAltitude)        .hexPolygonColor(() => {
  ...
  const startAnimation = () => {
    ...
    globeRef.current
      .arcsData(data)      .arcStartLat((d: any) => d.startLat * 1)
